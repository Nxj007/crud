...
$gn = $link->query($query2);
    ...
    $sql1 = "UPDATE `employees` SET ('$name', '$email', '$password', '$det' ,'$gender', '$salary', '$age')  WHERE id='$id' ";
...
<body>
    ...
    <form name="contactForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" onsubmit="return validateform()">
        ...
        <fieldset>
            ...
            <input type="radio" name="sx" <?php if (in_array($gender, $value)) {echo "checked";} ?> value="<?php echo ($value['sx']); ?>">
