                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            if (isset($_GET['update'])) {
                                ...
                                //     $h_array[] = $h1;
                                // }
                                foreach ($h_run as $row_h) {
                                    $h_array = $row_h['hid'];
                                    // echo "<td>" . var_dump($h_array) . "</td>";
                                    // exit;
                                }
                            }
                            // $h2 = implode(",", $h_array);
                            ...
                            <select name="hob[]" multiple>
                                ...
                                <?php foreach ($hob as $h1 => $value) : ?>
                                    ...
                                    ?>
                                    <option value="<?php echo $value['hid'] ?>" <?php echo in_array($value['hid'], $row_h) ? 'selected' : '' ?>>
                        ...
                        //     $query = "SELECT * FROM e_hob WHERE emp_id='$eid'";
                        //     $q_run = mysqli_query($link, $query);
                        //     $hob_val = [];
                        //     foreach ($q_run as $hob_data) {
                        //         $hob_val[] = $hob_data['h_id'];
                        //     }
                        // }
                        // foreach ($hob_in as $in_val) {
                        //     if (!in_array($in_val, $hob_val)) {
                        //         echo $in_val;
                        //         exit;
                        //         $insert_arr = "INSERT INTO e_hob(emp_id,h_id)values('$eid','$in_val')";
                        //         $insert_arr_run = mysqli_query($link, $insert_arr);
                        //     }
                        // }

                        // //DELETE
                        // foreach ($hob_val as $hob_row) {
                        //     if (!in_array($hob_row, $hob_in)) {
                        //         //echo $hob_row;
                        //         $delete_q = "DELETE FROM e_hob WHERE emp_id='$eid' AND h_id='$hob_row'";
                        //         $delete_q_run = mysqli_query($link, $delete_q);
                        //     }
                        // }
                        ...
                        <div class="form-group">
                            ...
                            <div class="error" id="ageErr">*<?php echo $age_err; ?></div>
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        if (isset($_POST["update"])) {
                            ...
                            $q_run = mysqli_query($link, $query);
                            $hob_val1 = [];
                            foreach ($q_run as $hob_data) { //1 
                                $hob_val1[] = $hob_data['h_id'];
                            }
                        }

                        foreach ($hob_in as $in_val) { //2
                            if (!in_array($in_val, $hob_val1)) {
                                // echo $in_val;
                                // exit;
                                $insert_arr = "INSERT INTO e_hob(emp_id,h_id)values('$eid','$in_val')";
                                $insert_arr_run = mysqli_query($link, $insert_arr);
