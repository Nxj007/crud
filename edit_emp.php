  ...
  <div class="container mt-4">
    ...
    <form action="" method="post" enctype="multipart/form-data">
      <div class="mb-3">
        ...
        <input type="email" class="form-control" value="<?php echo  $username; ?>" placeholder="Enter email" name="emp_email" required>
      ...
      <div class="mb-3">
        ...
        <input type="lname" class="form-control" value="<?php echo $lastname; ?>" placeholder="Last Name" name="emp_lname" required>
      ...
      <div class="mb-3">
        ...
        <div class="form-group">
          ...
          if (isset($_GET['edit'])) {
            $edit_id = $_GET['edit'];
            $user_hob = "SELECT h_id FROM hobbies WHERE emp_id='$edit_id'";
    ...
    if ($_SESSION['username'] == 'kalyani@gmail.com') {
      if (isset($_POST["inset-btn"])) {
        $eusername = $_POST["emp_email"];
        $employee_fname = $_POST['emp_fname'];
        $employee_lname = $_POST['emp_lname'];
