                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select name="hob[]" multiple>
                                <?php foreach ($hob as $h1 => $value) : ?>
                                    <option <?php if (in_array($hh, $value)) {
                                                echo "selected";
                                            } ?> value="<?php echo $hh ?>"> <?php echo htmlspecialchars($value['h_nm']); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <?php foreach ($qa as $q1 => $value1) : ?>
                                <input type="checkbox" name="qa[]" <?php if (in_array($qq, $value1)) echo "checked"; ?> value="<?php echo $value1['q_nm'] ?>">
